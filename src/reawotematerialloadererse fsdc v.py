...
class ReawoteMaterialDialog(gui.GeDialog):
    ...
    def CreateLayout(self):
        ...
        self.GroupEnd()
        # self.GroupBegin(ID.DIALOG_SCROLL_GROUP, c4d.BFH_SCALEFIT|c4d.BFV_SCALEFIT, 2, 1, "Sccrroll gooruu", 0, 10, 10)
        self.AddEditText(ID.DIALOG_FOLDER_LIST, c4d.BFH_SCALEFIT, initw=50, inith=50)
        # self.GroupEnd()
    ...
    def HandleFolderSelect(self):
        ...
        # TODO predelat tohle na for cyklus pro vsechny oznacene slozky v seznamu obsazenych slozek
...
class ReawoteMaterialLoader(plugins.CommandData):
    ...
    def Execute(self, doc):
        dialog.Open(c4d.DLG_TYPE_ASYNC, REAWOTE_PLUGIN_ID, -1, -1, 400, 400)
        return True
